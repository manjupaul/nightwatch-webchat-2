...
describe('Question Flow', function() {
  ...
  it('Deve abrir a URL com o fluxo de questões', function(browser) {
    browser
      .url(URL)
  ...
  it('Deve haver as opções de resposta em botões', function(browser) {
    browser
  ...
  it('Deve clicar no botão \'sim\' e receber uma resposta', function(browser) {
    browser
  ...
  it('Deve clicar no botão \'nao\' e receber uma resposta', function(browser) {
    browser
